...
// Even or Odd: Write an `if-else` statement to check if a number is even. Print "Even" if true, otherwise
//"Odd."
...
//Vowel or Consonant: Write an `if-else` statement to check if a given character is a vowel. Print "Vowel"
...
// Check Zero: Write an `if-else` statement to check if a number is zero. Print "Zero" if true, otherwise
//"Non-zero."
...
// Eligible for Discount: Write an `if-else` statement to check if a customer’s age is 65 or older. Print
// "Eligible for senior discount" if true, otherwise "Not eligible."


// let customer_age=70;
// if(customer_age>=65){
//     console.log("eligible to senior discount")
// }
// else{
...
// let age=20;
// if(age>=20){
//     console.log("get driving license")
// }
...
// } else {
//     console.log("Multiple digit number");
// }
...
// }
// else{
//     console.log("string is not an empty")
// }
...
// let str="ravi!"
// if(str[str.length-1] =="!"){
//     console.log("ends with exclamation marks")
// }
// else{
//     console.log("not ends with exclamation marks")
// }
